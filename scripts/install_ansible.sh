...
cat ../server/ansible/ansible_malware_retrieval.yml >> /etc/ansible/ansible_malware_retrieval.yml

# Create python host retrieval
cat ../server/ansible/ansible_get_hosts.py >> /etc/ansible/ansible_get_hosts.py
